...
print("Percentage of zero entries in paternal data matrix with 40 groups")
sum(pat_data_matrix_40==0)/(nrow(pat_data_matrix_40)*ncol(pat_data_matrix_40))*100

print("Percentage of zero entries in paternal data matrix with 119 groups")
sum(pat_data_matrix_119==0)/(nrow(pat_data_matrix_119)*ncol(pat_data_matrix_119))*100
...
print("Percentage of zero entries in maternal data matrix with 40 groups")
sum(mat_data_matrix_40==0)/(nrow(mat_data_matrix_40)*ncol(mat_data_matrix_40))*100

print("Percentage of zero entries in maternal data matrix with 119 groups")
sum(mat_data_matrix_119==0)/(nrow(mat_data_matrix_119)*ncol(mat_data_matrix_119))*100
